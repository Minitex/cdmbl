...
#         extractor.updatables.must_equal [['p16022coll44', '0']]
...
#                                 set_spec: 'bar',
#                                 oai_request_klass: oai_request_klass)
#       extractor.updatables.must_equal [
#                                                ['p16022coll44', '0'],
#                                                ['p16022coll44', '1']
#                                              ]
#       oai_request_klass.verify
...
#                                 }
#                               ]
#       oai_filter_klass_object.expect :updatables, 'foo'
#       oai_filter_klass_object.expect :deletables, 'bar'
#       extractor = Extractor.new(oai_endpoint: 'oai_endpoint_here',
#                                 resumption_token: 'foo',
#                                 set_spec: 'bar',
#                                 oai_request_klass: oai_request_klass,
#                                 oai_filter_klass: oai_filter_klass)
#       extractor.updatables.must_equal 'foo'
#       extractor.deletables.must_equal 'bar'
